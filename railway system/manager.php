...
.btnset{
 ...
 <body>
     ...
     echo "<a href='employee_register.php' class='clgr'>"."Add new Employees"."</a>";
     echo "<a href='update_employee.php' class='clgr'>"."Update Employee"."</a>";
     echo "<a href='search_employee.php' class='clgr'>"."Search Employee"."</a>";

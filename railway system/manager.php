...
.set3{
 ...
 <body>
	...
	<div class="form-group row">
 		<div class="col-sm-10" class="page-header mb-5" align="center">
 			<a href="employee_register.php" class="clgr"><h3  class="form-control col-sm-3 btn btn-success set3" >Add new Employees</h3></a>
		</div>
	</div>
	...
	<div class="form-group row">
 		<div class="col-sm-10" class="page-header mb-5" align="center">
 			<a href="update_employee.php" class="clgr"><h3 class=" form-control col-sm-3 btn btn-success set3">Update Employee</h3></a>
 		</div>
	</div>
	...
	<div class="form-group row">
 		<div class="col-sm-10" class="page-header mb-5" align="center">
 			<a href="search_employee.php" class="clgr"><h3 class=" form-control col-sm-3 btn btn-success set3">Search Employee</h3></a>
 		</div>
	</div>
</div>

...
<?php
		    ...
		    $qry = " SELECT * FROM ticket, customer, train_fare where customer.cust_id = ticket.cust_id And ticket_confirm = 'No' And ticket.ticket_num = train_fare.ticket_num ";
			...
			if ($res->num_rows>0) {
				...
				$result .= "<tr class='tblh'><th>Train Number</th></th><th>CNIC</th><th>Name</th><th>Source</th><th>Destination</th><th>Ticket Cancel</th></tr>";
				while ($row = $res->fetch_assoc()) 
				{
                    $result .= "<tr class ='".$class."'>
                                    ...
                                    <td>
                                    "."<span><a class='btn btn-success' href='remove_ticket.php?tid={$row['ticket_num']}'>Cancel</a></span>" ."
                                    </td>
